const translations = {
    "en": {
        ...
        "GNSS-IR Remote Water Sensing Device": {
            ...
            "GNSS-results": "The daily average water level accuracy was achieved within 5cm. Data transmission and reception at the ground control station were completed in under one hour. During deployment testing, the system withstood snow, windstorms, and rainstorms. Check the open-source code in my GitHub account.",
        ...
        "global-content": {
            ...
            "morocco-p6": "After France, I flew to Morocco in July 2024 and did a solo backbacking trip all over the place for two weeks. The theme of this trip was to see, know, and understand the Isramic life and culture. I started in:",
    ...
    "jp": {
        ...
        "GNSS-IR Remote Water Sensing Device": {
            ...
            "GNSS-R-title": "結果",
            "GNSS-results": "毎日の平均水位精度は5cm以内と精度を保った、信頼性のあるシステムが完成しました。データの送受信は地上制御ステーションで最低1時間以内。実証試験期間中、雪、時速40mの強風、豪雨に見舞われたが、問題なく作動することができました。",
        ...
        "global-content": {
            ...
            "morocco-p6": "フランスの後、2024年7月にモロッコに飛び、2週間の一人旅をしました。この旅行のテーマは、イスラムの生活と文化を見て、知り、理解すること。旅の始まりは：",
